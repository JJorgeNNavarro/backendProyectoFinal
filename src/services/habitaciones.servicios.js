...
export const createHabitacionService = async ({titulo, descripcion1,descripcion2,descripcion3,imagen1,tipo, precio}) => {
...
export const putHabitacionesService = async ({titulo, descripcion1,descripcion2,descripcion3,imagen1,id,tipo, precio}) =>{
   const query = {}
